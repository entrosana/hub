...
PREFIX = "/api/v1"
for r in (
    identity_router, audit_router, accounting_router, admin_router,
    scheduling_router, contracts_router, expenses_router, taxes_router,
    signup_router, addresses_router, billing_router, documents_router,
):
